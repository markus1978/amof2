...
public class IteratorExpASImpl
  ...
  implements IteratorExpAS,
             expressionsVisitable
{
  //--- Constructors ---
  public IteratorExpASImpl() {
  ...
  public void destroy(uk.ac.kent.cs.kmf.patterns.Factory factory) {
  	factory.destroy("IteratorExpAS",this);
  }

  public void destroy(uk.ac.kent.cs.kmf.patterns.Repository rep) {
  	rep.removeElement("uk.ac.kent.cs.ocl20.syntax.ast.expressions.IteratorExpAS",this);
  }
...
"}";
  ...
  public boolean equals(java.lang.Object o) {
    if (o instanceof IteratorExpAS) {
      try {
        IteratorExpAS obj = (IteratorExpAS)o;
        return (this == o);
  ...
  public java.lang.Object clone() {
    IteratorExpAS obj = new IteratorExpASImpl();
