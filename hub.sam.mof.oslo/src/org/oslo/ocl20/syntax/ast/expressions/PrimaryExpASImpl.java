...
public class PrimaryExpASImpl
  ...
  implements PrimaryExpAS,
             expressionsVisitable
{
  //--- Constructors ---
  public PrimaryExpASImpl() {
  ...
  public void destroy(uk.ac.kent.cs.kmf.patterns.Factory factory) {
  	factory.destroy("PrimaryExpAS",this);
  }

  public void destroy(uk.ac.kent.cs.kmf.patterns.Repository rep) {
  	rep.removeElement("uk.ac.kent.cs.ocl20.syntax.ast.expressions.PrimaryExpAS",this);
  }
...
"}";
  ...
  public boolean equals(java.lang.Object o) {
    if (o instanceof PrimaryExpAS) {
      try {
        PrimaryExpAS obj = (PrimaryExpAS)o;
        return (this == o);
  ...
  public java.lang.Object clone() {
    PrimaryExpAS obj = new PrimaryExpASImpl();
