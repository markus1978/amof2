...
public class SetTypeASImpl
  ...
  implements SetTypeAS,
             typesVisitable
{
  //--- Constructors ---
  public SetTypeASImpl() {
  ...
  public void destroy(uk.ac.kent.cs.kmf.patterns.Factory factory) {
  	factory.destroy("SetTypeAS",this);
  }

  public void destroy(uk.ac.kent.cs.kmf.patterns.Repository rep) {
  	rep.removeElement("uk.ac.kent.cs.ocl20.syntax.ast.types.SetTypeAS",this);
  }
...
"}";
  ...
  public boolean equals(java.lang.Object o) {
    if (o instanceof SetTypeAS) {
      try {
        SetTypeAS obj = (SetTypeAS)o;
        return (this == o);
  ...
  public java.lang.Object clone() {
    SetTypeAS obj = new SetTypeASImpl();
