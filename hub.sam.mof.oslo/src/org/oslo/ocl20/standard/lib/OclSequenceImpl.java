...
public class OclSequenceImpl extends OclCollectionImpl implements OclSequence {
	...
	protected OclSequenceImpl(Classifier eT, Object[] array, StdLibAdapter adapter) {
		super(eT, adapter);
	...
	public OclBoolean equalTo(OclSequence sequence2) {
		if ( ((Boolean)this.size().equalTo(sequence2.size()).not().asJavaObject()).booleanValue() )
	...
	public boolean equals(Object o) {
		return (o instanceof OclSequence) ? ((Boolean)equalTo((OclSequence)o).asJavaObject()).booleanValue() : false;
	}
