...
public class LoopExp$Class
implements
    LoopExp,
    SemanticsVisitable
{
	/** Default constructor */
	public LoopExp$Class() {
	...
	public LoopExp$Class(String name, Boolean isMarkedPre) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'isMarkedPre' from 'OclExpression' ---
	...
	/** Accept 'uk.ac.kent.cs.ocl20.semantics.model.expressions.LoopExp$Visitor' */
	...
	/** Clone the object */
	public Object clone() {
		LoopExp$Class obj = new LoopExp$Class();
