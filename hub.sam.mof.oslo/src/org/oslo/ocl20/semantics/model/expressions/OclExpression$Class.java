/**
 *
 *  Class OclExpression$Class.java
 *
...
public class OclExpression$Class
implements
    OclExpression,
    SemanticsVisitable
{
	/** Default constructor */
	public OclExpression$Class() {
	...
	public OclExpression$Class(String name, Boolean isMarkedPre) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'isMarkedPre' from 'OclExpression' ---
	...
	/** Accept 'uk.ac.kent.cs.ocl20.semantics.model.expressions.OclExpression$Visitor' */
	...
	/** Clone the object */
	public Object clone() {
		OclExpression$Class obj = new OclExpression$Class();
