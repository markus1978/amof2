...
public class VariableExp$Class
implements
    VariableExp,
    SemanticsVisitable
{
	/** Default constructor */
	public VariableExp$Class() {
		...
		this.loopExp = null;
		//--- Set property 'referredVariable' from 'VariableExp' ---
		this.referredVariable = null;
	}
	/** Specialized constructor */
	public VariableExp$Class(String name, Boolean isMarkedPre) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'isMarkedPre' from 'OclExpression' ---
	...
	/** Property 'referredVariable' from 'VariableExp' */
	protected VariableDeclaration referredVariable;
	/** Get property 'referredVariable' from 'VariableExp' */
	...
	/** Accept 'uk.ac.kent.cs.ocl20.semantics.model.expressions.VariableExp$Visitor' */
	...
	/** Clone the object */
	public Object clone() {
		VariableExp$Class obj = new VariableExp$Class();
		...
		obj.referredVariable = referredVariable==null ? null : this.referredVariable;
		return obj;
	}
}
