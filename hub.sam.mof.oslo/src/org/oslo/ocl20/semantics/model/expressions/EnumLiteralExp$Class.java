/**
 *
 *  Class EnumLiteralExp$Class.java
 *
...
public class EnumLiteralExp$Class
implements
    EnumLiteralExp,
    SemanticsVisitable
{
	/** Default constructor */
	public EnumLiteralExp$Class() {
		...
		this.loopExp = null;
		//--- Set property 'referredEnumLiteral' from 'EnumLiteralExp' ---
		this.referredEnumLiteral = null;
	}
	/** Specialized constructor */
	public EnumLiteralExp$Class(String name, Boolean isMarkedPre) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'isMarkedPre' from 'OclExpression' ---
	...
	/** Property 'referredEnumLiteral' from 'EnumLiteralExp' */
	protected org.oslo.ocl20.semantics.bridge.EnumLiteral referredEnumLiteral;
	/** Get property 'referredEnumLiteral' from 'EnumLiteralExp' */
	...
	/** Accept 'uk.ac.kent.cs.ocl20.semantics.model.expressions.EnumLiteralExp$Visitor' */
	...
	/** Clone the object */
	public Object clone() {
		EnumLiteralExp$Class obj = new EnumLiteralExp$Class();
		...
		obj.referredEnumLiteral = referredEnumLiteral==null ? null : this.referredEnumLiteral;
		return obj;
	}
}
