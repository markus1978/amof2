/**
 *
 *  Class TupleLiteralExp$Class.java
 *
...
public class TupleLiteralExp$Class
implements
    TupleLiteralExp,
    SemanticsVisitable
{
	/** Default constructor */
	public TupleLiteralExp$Class() {
	...
	public TupleLiteralExp$Class(String name, Boolean isMarkedPre) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'isMarkedPre' from 'OclExpression' ---
	...
	/** Property 'tuplePart' from 'TupleType' */
	protected List tuplePart;
	/** Get property 'tuplePart' from 'TupleType' */
	public List getTuplePart() {
		return tuplePart;
	}
	/** Set property 'tuplePart' from 'TupleType' */
	public void setTuplePart(List tuplePart) { 
	...
	/** Accept 'uk.ac.kent.cs.ocl20.semantics.model.expressions.TupleLiteralExp$Visitor' */
	...
	/** Clone the object */
	public Object clone() {
		TupleLiteralExp$Class obj = new TupleLiteralExp$Class();
