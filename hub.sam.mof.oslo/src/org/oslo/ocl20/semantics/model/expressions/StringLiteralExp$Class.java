/**
 *
 *  Class StringLiteralExp$Class.java
 *
 *  Generated by KMFStudio at 09 May 2003 17:47:53
...
public class StringLiteralExp$Class
implements
    StringLiteralExp,
    SemanticsVisitable
{
	/** Default constructor */
	public StringLiteralExp$Class() {
		...
		this.loopExp = null;
		//--- Set property 'stringSymbol' from 'StringLiteralExp' ---
		this.stringSymbol = null;
	}
	/** Specialized constructor */
	public StringLiteralExp$Class(String name, Boolean isMarkedPre, String stringSymbol) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'isMarkedPre' from 'OclExpression' ---
	...
	/** Property 'stringSymbol' from 'StringLiteralExp' */
	protected String stringSymbol;
	/** Get property 'stringSymbol' from 'StringLiteralExp' */
	...
	/** Accept 'uk.ac.kent.cs.ocl20.semantics.model.expressions.StringLiteralExp$Visitor' */
	...
	/** Clone the object */
	public Object clone() {
		StringLiteralExp$Class obj = new StringLiteralExp$Class();
		...
		obj.stringSymbol = stringSymbol==null ? null : this.stringSymbol;
		return obj;
	}
}
