/**
 *
 *  Class RealLiteralExp$Class.java
 *
...
public class RealLiteralExp$Class
implements
    RealLiteralExp,
    SemanticsVisitable
{
	/** Default constructor */
	public RealLiteralExp$Class() {
		...
		this.loopExp = null;
		//--- Set property 'realSymbol' from 'RealLiteralExp' ---
		this.realSymbol = null;
	}
	/** Specialized constructor */
	public RealLiteralExp$Class(String name, Boolean isMarkedPre, Double realSymbol) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'isMarkedPre' from 'OclExpression' ---
	...
	/** Property 'realSymbol' from 'RealLiteralExp' */
	protected Double realSymbol;
	/** Get property 'realSymbol' from 'RealLiteralExp' */
	...
	/** Accept 'uk.ac.kent.cs.ocl20.semantics.model.expressions.RealLiteralExp$Visitor' */
	...
	/** Clone the object */
	public Object clone() {
		RealLiteralExp$Class obj = new RealLiteralExp$Class();
		...
		obj.realSymbol = realSymbol==null ? null : (Double)this.realSymbol;
		return obj;
	}
}
