/**
 *
 *  Class NumericalLiteralExp$Class.java
 *
...
public class NumericalLiteralExp$Class
implements
    NumericalLiteralExp,
    SemanticsVisitable
{
	/** Default constructor */
	public NumericalLiteralExp$Class() {
	...
	public NumericalLiteralExp$Class(String name, Boolean isMarkedPre) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'isMarkedPre' from 'OclExpression' ---
	...
	public String toString() {
		String strId = "NumericalLiteralExp";
		String name = null;
		try {
	...
	/** Accept 'uk.ac.kent.cs.ocl20.semantics.model.expressions.NumericalLiteralExp$Visitor' */
	...
	/** Clone the object */
	public Object clone() {
		NumericalLiteralExp$Class obj = new NumericalLiteralExp$Class();
