/**
 *
 *  Class IntegerLiteralExp$Class.java
 *
...
public class IntegerLiteralExp$Class
implements
    IntegerLiteralExp,
    SemanticsVisitable
{
	/** Default constructor */
	public IntegerLiteralExp$Class() {
		...
		this.loopExp = null;
		//--- Set property 'integerSymbol' from 'IntegerLiteralExp' ---
		this.integerSymbol = null;
	}
	/** Specialized constructor */
	public IntegerLiteralExp$Class(String name, Boolean isMarkedPre, Integer integerSymbol) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'isMarkedPre' from 'OclExpression' ---
	...
	/** Property 'integerSymbol' from 'IntegerLiteralExp' */
	protected Integer integerSymbol;
	/** Get property 'integerSymbol' from 'IntegerLiteralExp' */
	...
	public String toString() {
		String strId = "IntegerLiteralExp";
		String name = null;
		try {
	...
	/** Accept 'uk.ac.kent.cs.ocl20.semantics.model.expressions.IntegerLiteralExp$Visitor' */
	...
	/** Clone the object */
	public Object clone() {
		IntegerLiteralExp$Class obj = new IntegerLiteralExp$Class();
		...
		obj.integerSymbol = integerSymbol==null ? null : this.integerSymbol;
		return obj;
	}
}
