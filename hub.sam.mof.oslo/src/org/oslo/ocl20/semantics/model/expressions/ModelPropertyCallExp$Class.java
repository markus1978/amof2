/**
 *
 *  Class ModelPropertyCallExp$Class.java
 *
 *  Generated by KMFStudio at 09 May 2003 17:47:48
...
public class ModelPropertyCallExp$Class
implements
    ModelPropertyCallExp,
    SemanticsVisitable
{
	/** Default constructor */
	public ModelPropertyCallExp$Class() {
	...
	public ModelPropertyCallExp$Class(String name, Boolean isMarkedPre) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'isMarkedPre' from 'OclExpression' ---
	...
	public String toString() {
		String strId = "ModelPropertyCallExp";
		String name = null;
		try {
	...
	/** Accept 'uk.ac.kent.cs.ocl20.semantics.model.expressions.ModelPropertyCallExp$Visitor' */
	...
	/** Clone the object */
	public Object clone() {
		ModelPropertyCallExp$Class obj = new ModelPropertyCallExp$Class();
