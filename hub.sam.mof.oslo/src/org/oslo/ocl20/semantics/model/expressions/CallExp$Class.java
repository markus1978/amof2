...
public class CallExp$Class
implements
    CallExp,
    SemanticsVisitable
{
	/** Default constructor */
	public CallExp$Class() {
	...
	public CallExp$Class(String name, Boolean isMarkedPre) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'isMarkedPre' from 'OclExpression' ---
	...
	/** Accept 'uk.ac.kent.cs.ocl20.semantics.model.expressions.CallExp$Visitor' */
	...
	/** Clone the object */
	public Object clone() {
		CallExp$Class obj = new CallExp$Class();
