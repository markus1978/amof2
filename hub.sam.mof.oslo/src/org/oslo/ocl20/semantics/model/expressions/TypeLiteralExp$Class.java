...
public class TypeLiteralExp$Class
implements
    TypeLiteralExp,
    SemanticsVisitable
{
	/** Default constructor */
	public TypeLiteralExp$Class() {
	...
	public TypeLiteralExp$Class(String name, Boolean isMarkedPre, Classifier litType) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'isMarkedPre' from 'OclExpression' ---
	...
	Classifier litType;
	public Classifier getLiteralType() { return litType; }
	...
	/** Clone the object */
	public Object clone() {
		TypeLiteralExp$Class obj = new TypeLiteralExp$Class();
		...
		obj.litType = litType==null ? null : this.litType;
		return obj;
	}
}
