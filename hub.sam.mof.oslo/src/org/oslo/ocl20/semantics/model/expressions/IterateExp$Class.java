/**
 *
 *  Class IterateExp$Class.java
 *
 *  Generated by KMFStudio at 09 May 2003 17:47:47
...
public class IterateExp$Class
implements
    IterateExp,
    SemanticsVisitable
{
	/** Default constructor */
	public IterateExp$Class() {
		...
		this.body = null;
		//--- Set property 'result' from 'IterateExp' ---
		this.result = null;
	}
	/** Specialized constructor */
	public IterateExp$Class(String name, Boolean isMarkedPre) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'isMarkedPre' from 'OclExpression' ---
	...
	/** Property 'result' from 'IterateExp' */
	protected VariableDeclaration result;
	/** Get property 'result' from 'IterateExp' */
	...
	/** Accept 'uk.ac.kent.cs.ocl20.semantics.model.expressions.IterateExp$Visitor' */
	...
	/** Clone the object */
	public Object clone() {
		IterateExp$Class obj = new IterateExp$Class();
