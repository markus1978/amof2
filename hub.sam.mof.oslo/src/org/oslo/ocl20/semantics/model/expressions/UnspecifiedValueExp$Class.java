/**
 *
 *  Class UnspecifiedValueExp$Class.java
 *
 *  Generated by KMFStudio at 09 May 2003 17:47:50
...
public class UnspecifiedValueExp$Class
implements
    UnspecifiedValueExp,
    SemanticsVisitable
{
	/** Default constructor */
	public UnspecifiedValueExp$Class() {
	...
	public UnspecifiedValueExp$Class(String name, Boolean isMarkedPre) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'isMarkedPre' from 'OclExpression' ---
	...
	public String toString() {
		String strId = "UnspecifiedValueExp";
		String name = null;
		try {
	...
	/** Accept 'uk.ac.kent.cs.ocl20.semantics.model.expressions.UnspecifiedValueExp$Visitor' */
	...
	/** Clone the object */
	public Object clone() {
		UnspecifiedValueExp$Class obj = new UnspecifiedValueExp$Class();
