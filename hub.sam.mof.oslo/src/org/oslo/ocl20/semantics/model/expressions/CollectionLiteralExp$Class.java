/**
 *
 *  Class CollectionLiteralExp$Class.java
 *
...
public class CollectionLiteralExp$Class
implements
    CollectionLiteralExp,
    SemanticsVisitable
{
	/** Default constructor */
	public CollectionLiteralExp$Class() {
		...
		this.loopExp = null;
		//--- Set property 'kind' from 'CollectionLiteralExp' ---
		this.kind = null;
		//--- Set property 'parts' from 'CollectionLiteralExp' ---
		this.parts = new Vector();
	}
	/** Specialized constructor */
	public CollectionLiteralExp$Class(String name, Boolean isMarkedPre, CollectionKind kind) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'isMarkedPre' from 'OclExpression' ---
	...
	/** Property 'kind' from 'CollectionLiteralExp' */
	protected CollectionKind kind;
	/** Get property 'kind' from 'CollectionLiteralExp' */
	...
	/** Property 'parts' from 'CollectionLiteralExp' */
	protected List parts;
	/** Get property 'parts' from 'CollectionLiteralExp' */
	...
	public String toString() {
		String strId = "CollectionLiteralExp";
		String name = null;
		try {
	...
	/** Accept 'uk.ac.kent.cs.ocl20.semantics.model.expressions.CollectionLiteralExp$Visitor' */
	...
	/** Clone the object */
	public Object clone() {
		CollectionLiteralExp$Class obj = new CollectionLiteralExp$Class();
		...
		obj.kind = kind==null ? null : (CollectionKind)this.kind.clone();
		obj.parts = parts==null ? null : (List)((Vector)this.parts).clone();
		return obj;
	}
}
