/**
 *
 *  Class BooleanLiteralExp$Class.java
 *
...
public class BooleanLiteralExp$Class
implements
    BooleanLiteralExp,
    SemanticsVisitable
{
	/** Default constructor */
	public BooleanLiteralExp$Class() {
		...
		this.loopExp = null;
		//--- Set property 'booleanSymbol' from 'BooleanLiteralExp' ---
		this.booleanSymbol = null;
	}
	/** Specialized constructor */
	public BooleanLiteralExp$Class(String name, Boolean isMarkedPre, Boolean booleanSymbol) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'isMarkedPre' from 'OclExpression' ---
	...
	/** Property 'booleanSymbol' from 'BooleanLiteralExp' */
	protected Boolean booleanSymbol;
	/** Get property 'booleanSymbol' from 'BooleanLiteralExp' */
	...
	public String toString() {
		String strId = "BooleanLiteralExp";
		String name = null;
		try {
	...
	/** Accept 'uk.ac.kent.cs.ocl20.semantics.model.expressions.BooleanLiteralExp$Visitor' */
	...
	/** Clone the object */
	public Object clone() {
		BooleanLiteralExp$Class obj = new BooleanLiteralExp$Class();
		...
		obj.booleanSymbol = booleanSymbol==null ? null : this.booleanSymbol;
		return obj;
	}
}
