...
public class LiteralExp$Class
implements
    LiteralExp,
    SemanticsVisitable
{
	/** Default constructor */
	public LiteralExp$Class() {
	...
	public LiteralExp$Class(String name, Boolean isMarkedPre) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'isMarkedPre' from 'OclExpression' ---
	...
	/** Accept 'uk.ac.kent.cs.ocl20.semantics.model.expressions.LiteralExp$Visitor' */
	...
	/** Clone the object */
	public Object clone() {
		LiteralExp$Class obj = new LiteralExp$Class();
