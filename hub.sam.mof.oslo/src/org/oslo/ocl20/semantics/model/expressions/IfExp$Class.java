/**
 *
 *  Class IfExp$Class.java
 *
 *  Generated by KMFStudio at 09 May 2003 17:47:52
    ...
    SemanticsVisitable
{
	...
	public IfExp$Class() {
		...
		this.loopExp = null;
		//--- Set property 'condition' from 'IfExp' ---
		this.condition = null;
		//--- Set property 'thenExpression' from 'IfExp' ---
		this.thenExpression = null;
		//--- Set property 'elseExpression' from 'IfExp' ---
		this.elseExpression = null;
	}
	/** Specialized constructor */
	public IfExp$Class(String name, Boolean isMarkedPre) {
		//--- Set property 'name' from 'ModelElement' ---
		this.name = name;
		//--- Set property 'isMarkedPre' from 'OclExpression' ---
	...
	/** Property 'condition' from 'IfExp' */
	protected OclExpression condition;
	/** Get property 'condition' from 'IfExp' */
	...
	/** Property 'thenExpression' from 'IfExp' */
	protected OclExpression thenExpression;
	/** Get property 'thenExpression' from 'IfExp' */
	...
	/** Property 'elseExpression' from 'IfExp' */
	protected OclExpression elseExpression;
	/** Get property 'elseExpression' from 'IfExp' */
	...
	/** Accept 'uk.ac.kent.cs.ocl20.semantics.model.expressions.IfExp$Visitor' */
	...
	/** Clone the object */
	public Object clone() {
		IfExp$Class obj = new IfExp$Class();
