...
public class ASSimulator {
    ...
    public void execute() throws Exception {
        ...
        ActionSemanticsParser parser = new ActionSemanticsParser(new FileReader(new File("src/Traffic/Semantics.as")));
        ...
        java.lang.System.out.println("create and instantiate example model.");
