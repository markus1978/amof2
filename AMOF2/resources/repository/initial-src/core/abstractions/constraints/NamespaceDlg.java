...
public class NamespaceDlg extends hub.sam.mof.reflection.ObjectDlg implements Namespace
{
    ...
    public cmof.common.ReflectiveCollection<? extends core.abstractions.constraints.Constraint> getOwnedRule() {
        return (cmof.common.ReflectiveCollection<? extends core.abstractions.constraints.Constraint>)(java.lang.Object)self.getOwnedRule();
    }
