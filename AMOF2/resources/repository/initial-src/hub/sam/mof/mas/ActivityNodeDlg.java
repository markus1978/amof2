...
public class ActivityNodeDlg extends hub.sam.mof.reflection.ObjectDlg implements ActivityNode
{
    protected ActivityNode self = null;
    @Override
    protected void setSelf(cmof.reflection.Object self) {
        super.setSelf(self);
        this.self = (ActivityNode)self;
    }
