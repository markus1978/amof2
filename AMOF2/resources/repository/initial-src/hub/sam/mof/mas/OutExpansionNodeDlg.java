...
public class OutExpansionNodeDlg extends hub.sam.mof.reflection.ObjectDlg implements OutExpansionNode
{
    protected OutExpansionNode self = null;
    @Override
    protected void setSelf(cmof.reflection.Object self) {
        super.setSelf(self);
        this.self = (OutExpansionNode)self;
    }

    public hub.sam.mof.mas.ExpansionRegion getRegionAsOutput() {
        return (hub.sam.mof.mas.ExpansionRegion)(java.lang.Object)self.getRegionAsOutput();
    }

    public void setRegionAsOutput(hub.sam.mof.mas.ExpansionRegion value) {
        self.setRegionAsOutput(value);
    }
