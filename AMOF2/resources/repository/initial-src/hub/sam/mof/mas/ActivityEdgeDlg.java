...
public class ActivityEdgeDlg extends hub.sam.mof.reflection.ObjectDlg implements ActivityEdge
{
    protected ActivityEdge self = null;
    @Override
    protected void setSelf(cmof.reflection.Object self) {
        super.setSelf(self);
        this.self = (ActivityEdge)self;
    }
