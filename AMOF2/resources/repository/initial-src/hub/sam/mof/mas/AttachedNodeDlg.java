...
public class AttachedNodeDlg extends hub.sam.mof.reflection.ObjectDlg implements AttachedNode
{
    protected AttachedNode self = null;
    @Override
    protected void setSelf(cmof.reflection.Object self) {
        super.setSelf(self);
        this.self = (AttachedNode)self;
    }
