...
public class OpaqueActionDlg extends hub.sam.mof.reflection.ObjectDlg implements OpaqueAction
{
    protected OpaqueAction self = null;
    @Override
    protected void setSelf(cmof.reflection.Object self) {
        super.setSelf(self);
        this.self = (OpaqueAction)self;
    }

    public java.lang.String getActionBody() {
        return self.getActionBody();
    }

    public void setActionBody(java.lang.String value) {
        self.setActionBody(value);
    }

    public hub.sam.mof.mas.ActionKind getActionKind() {
        return (hub.sam.mof.mas.ActionKind)(java.lang.Object)self.getActionKind();
    }

    public void setActionKind(hub.sam.mof.mas.ActionKind value) {
        self.setActionKind(value);
    }
