...
public class ContextExtensionPinDlg extends hub.sam.mof.reflection.ObjectDlg implements ContextExtensionPin
{
    protected ContextExtensionPin self = null;
    @Override
    protected void setSelf(cmof.reflection.Object self) {
        super.setSelf(self);
        this.self = (ContextExtensionPin)self;
    }

    public java.lang.String getExtensionName() {
        return self.getExtensionName();
    }

    public void setExtensionName(java.lang.String value) {
        self.setExtensionName(value);
    }
