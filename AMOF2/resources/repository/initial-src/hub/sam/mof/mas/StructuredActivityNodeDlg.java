...
public class StructuredActivityNodeDlg extends hub.sam.mof.reflection.ObjectDlg implements StructuredActivityNode
{
    protected StructuredActivityNode self = null;
    @Override
    protected void setSelf(cmof.reflection.Object self) {
        super.setSelf(self);
        this.self = (StructuredActivityNode)self;
    }
