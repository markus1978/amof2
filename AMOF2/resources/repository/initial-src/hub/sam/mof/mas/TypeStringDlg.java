...
public class TypeStringDlg extends hub.sam.mof.reflection.ObjectDlg implements TypeString
{
    protected TypeString self = null;
    @Override
    protected void setSelf(cmof.reflection.Object self) {
        super.setSelf(self);
        this.self = (TypeString)self;
    }

    public cmof.common.ReflectiveSequence<java.lang.String> getQualifiedTypeName() {
        return self.getQualifiedTypeName();
    }
