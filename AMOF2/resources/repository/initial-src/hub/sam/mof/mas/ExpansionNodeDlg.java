...
public class ExpansionNodeDlg extends hub.sam.mof.reflection.ObjectDlg implements ExpansionNode
{
    protected ExpansionNode self = null;
    @Override
    protected void setSelf(cmof.reflection.Object self) {
        super.setSelf(self);
        this.self = (ExpansionNode)self;
    }
