...
public class GenerateRepository {
    ...
    public static void main(String[] args) throws Exception {                      
        ...
        Extent metaExtent = repository.createExtent("propertyNotificationTestMetaExtent");        
        repository.loadXmiIntoExtent(metaExtent, cmofPackage, "resources/models/test/property-notification-test.xml");        

        repository.generateCode(metaExtent, "resources/test/generated-src/");
        //repository.generateStaticModel(metaExtent, "warehouse.WarehouseModel", "resources/test/generated-src");
    }
}
