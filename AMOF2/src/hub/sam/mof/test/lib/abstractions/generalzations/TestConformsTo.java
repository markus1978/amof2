...
public class TestConformsTo extends AbstractTestRepository {
	
	public TestConformsTo() {
		super("test conformsTo()");
	}
	...
	public void testGetGeneral() {
		...
		assertEquals(true, class5.conformsTo(class5));
		assertEquals(true, class5.conformsTo(class4));
		assertEquals(false, class4.conformsTo(class3));
	}
}
