...
public class GenerateTestRepository {
    ...
    public static void main(String[] args) {
        ...
        try {
            repository.loadMagicDrawXmiIntoExtent(masExtent, cmofPackage, "resources/models/MASTest.syntax.mdxml");

            Package asPackage = (Package) masExtent.query("Package:tests");            
            ...
            ((Package) masExtent.query("Package:tests")).getTag().add(packagePrefixTag);            
