...
import hub.sam.mas.editor.editparts.properties.handlers.CommentedNodeHandler;
import hub.sam.mas.editor.editparts.properties.handlers.DecisionNodeHandler;
import hub.sam.mas.model.mas.DecisionNode;

public class DecisionNodePropertySource extends AbstractPropertySource {
    
    private DecisionNode model;
    ...
    protected void createPropertyHandlers() {
        ...
        installPropertyHandler(new DecisionNodeHandler(model));
    }
